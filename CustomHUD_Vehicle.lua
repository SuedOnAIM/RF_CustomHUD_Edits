...
function CustomHUD_Vehicle:updateVehicleHealth()
	...
	local vehicleHealth = Mathf.Round((Player.actor.activeVehicle.health/Player.actor.activeVehicle.maxHealth)*100)
	--currently displays health percentage of vehicle
	--local healthText = vehicleHealth .. "/" .. Player.actor.activeVehicle.maxHealth
	local healthText = vehicleHealth
